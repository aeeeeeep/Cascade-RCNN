...
async def main():
    ...
    img = mmcv.imread(os.path.join(project_dir, 'demo/demo.png'))
    ...
    show_result(
        ...
        score_thr=0.5,
        show=False,
        out_file=os.path.join(result_dir, 'result_async.png'))
    show_result(
        img,
        sync_results[0],
        model.CLASSES,
        score_thr=0.5,
        show=False,
        out_file=os.path.join(result_dir, 'result_sync.png'))
